...
public class EggplantLogic : MonoBehaviour
{
    ...
    {
        return new PlantData(DateTime.Now.ToString(DATETIME_FORMAT), transform.localPosition, growthAmount, growthRate, witherTime, 3);
    }
